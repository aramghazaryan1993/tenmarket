...
class CreateTenOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ten_orders', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `ten_orders` comment 'Заявки на изготовление ТЭНов'");
    }
    ...
    {
        Schema::dropIfExists('ten_orders');
    }
}
